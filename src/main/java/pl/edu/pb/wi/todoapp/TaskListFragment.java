...
public class TaskListFragment extends Fragment {
    ...
    public static final String KEY_SAVE_SUBTITLE_VISIBLE_ID = "save_subtitle";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        {
            subtitleVisible = savedInstanceState.getBoolean(KEY_SAVE_SUBTITLE_VISIBLE_ID);
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.new_task:
                Task task = new Task("", false, Category.HOME);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean(KEY_SAVE_SUBTITLE_VISIBLE_ID, subtitleVisible);
    }
}
